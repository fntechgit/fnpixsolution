<%@ Page Title="FNPIX > Dropbox Media" Language="C#" MasterPageFile="~/fnpix.master" AutoEventWireup="true" CodeBehind="dropbox_media.aspx.cs" Inherits="fnpix.dropbox_media" %>
									...
									<ul>
										...
										<li class="right" data-sort-source data-sort-id="media-gallery">
											<ul class="nav nav-pills nav-pills-primary">
												...
												<li>
													<a data-option-value=".approved" href="#instagram">Approved</a>
												</li>
												<li>
													<a data-option-value=".unapproved" href="#twitter">Unapproved</a>
												</li>
											</ul>
										</li>
									</ul>
