									...
									<div class="panel-body">
										<div class="form-horizontal form-bordered">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<div class="m-md slider-primary" data-plugin-slider data-plugin-options='{ "value": 5, "range": "min" : 1, "max": 60 }' data-plugin-slider-output="#listenSlider">
                                                        <asp:HiddenField runat="server" ID="listenSlider" ClientIDMode="Static" Value="5" />
													</div>
													<p class="output">Update Interval <code>(minutes)</code>: <b><%= interval %></b></p>
												</div>
											</div>
