...
namespace overrideSocial
{
    ...
    partial void OnemailChanging(string value);
    partial void OnemailChanged();
    partial void OnoptimizedChanging(string value);
    partial void OnoptimizedChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_optimized", DbType="VarChar(MAX)")]
		public string optimized
		{
			...
			set
			{
				...
				{
					this.OnoptimizedChanging(value);
					this.SendPropertyChanging();
					this._optimized = value;
					this.SendPropertyChanged("optimized");
	...
	public partial class event_master : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _background_1920;
		
		private string _background_1280;
		
		private bool _force_refresh;
		
		private System.DateTime _last_screen_refresh;
    ...
    partial void Onbackground_1920Changing(string value);
    partial void Onbackground_1920Changed();
    partial void Onbackground_1280Changing(string value);
    partial void Onbackground_1280Changed();
    partial void Onforce_refreshChanging(bool value);
    partial void Onforce_refreshChanged();
    partial void Onlast_screen_refreshChanging(System.DateTime value);
    partial void Onlast_screen_refreshChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_background_1920", DbType="VarChar(MAX)")]
		public string background_1920
		{
			get
			{
				return this._background_1920;
			}
			set
			{
				if ((this._background_1920 != value))
				{
					this.Onbackground_1920Changing(value);
					this.SendPropertyChanging();
					this._background_1920 = value;
					this.SendPropertyChanged("background_1920");
					this.Onbackground_1920Changed();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_background_1280", DbType="VarChar(MAX)")]
		public string background_1280
		{
			get
			{
				return this._background_1280;
			}
			set
			{
				if ((this._background_1280 != value))
				{
					this.Onbackground_1280Changing(value);
					this.SendPropertyChanging();
					this._background_1280 = value;
					this.SendPropertyChanged("background_1280");
					this.Onbackground_1280Changed();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_force_refresh", DbType="Bit NOT NULL")]
		public bool force_refresh
		{
			get
			{
				return this._force_refresh;
			}
			set
			{
				if ((this._force_refresh != value))
				{
					this.Onforce_refreshChanging(value);
					this.SendPropertyChanging();
					this._force_refresh = value;
					this.SendPropertyChanged("force_refresh");
					this.Onforce_refreshChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_last_screen_refresh", DbType="DateTime NOT NULL")]
		public System.DateTime last_screen_refresh
		{
			get
			{
				return this._last_screen_refresh;
			}
			set
			{
				if ((this._last_screen_refresh != value))
				{
					this.Onlast_screen_refreshChanging(value);
					this.SendPropertyChanging();
